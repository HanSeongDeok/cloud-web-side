...
import { createfilterInfo } from "@/handlers/events/filterSearch.service.handler";
 ...
 * @returns 데이터 입력 컴포넌트
 */
const DataInput = ({ pageType }: { pageType: string }) => {
  ...
  const handleSearch = () => {
    ...
    const basicSearchInfo = createfilterInfo(
      filterLutSected,
      paginationInfo,
      searchKeyword,
      "BASIC_SEARCH"
  ...
  return (
    <div className="flex justify-center w-full mb-4">
      <div className="relative w-full">
        ...
        />
        <AdvancedSearch pageType={pageType} />
      </div>
    </div>
  );
};
