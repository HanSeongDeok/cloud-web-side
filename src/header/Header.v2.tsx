                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col leading-tight">
                                            <span className="text-lg sm:text-lg font-bold flex items-center">
                                                임베디드연구소 차량솔루션팀 / {permissionData.name || "개발자"}
                                                <ChevronDownIcon
                                            ...
                                            <span className="text-xs sm:text-sm text-blue-400">
                                                {permissionData.role || 'developer'} <span className="text-gray-400 ml-1">({getRoleDisplayName(permissionData.role)})</span>
                                                &nbsp;
                                            </span>
                                        </div>
                                    </button>
